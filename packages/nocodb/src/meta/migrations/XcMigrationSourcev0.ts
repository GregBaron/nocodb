...
import * as nc_014_automation_is_polling from './v0/nc_014_automation_is_polling';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_014_automation_is_polling':
        return nc_014_automation_is_polling;
    }
  }
}
